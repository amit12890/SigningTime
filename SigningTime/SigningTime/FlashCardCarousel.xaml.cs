    ...
    public partial class FlashCardCarousel : CarouselPage
    {
        public FlashCardCarousel()
        {
            ...
            List<Sign> allSigns = new List<Sign>(){
                ...
                new Sign { Name = "where", Description = "With your pointer finger up, shake your hand from side to side, like you are not sure where to point." }, // TODO: NEED THIS VIDEO DOWNLOADED
            };
